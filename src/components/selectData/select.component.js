(function (angular) {
  ...
  selectData = {
    ...
    '<ui-select-choices  id="text1" ng-style="{{sc.customStyle}}" repeat="entidad in (sc.entidadesFiltradas = ( sc.entidades | propsFilter: sc.getSearch($select)))" >    ' +
    ...
    '<button type="button" ng-click="sc.clickButton($select)" class="btn btn-default">      ' +
    '<span ng-class="sc.getClass()"></span>      </button>      </span></div>',
